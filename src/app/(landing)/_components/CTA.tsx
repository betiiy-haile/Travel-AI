  ...
  return (
    <section className="py-16 flex items-center justify-center">
      <div className="w-full md:w-4/5 lg:w-3/4 text-center flex flex-col gap-5 px-4 md:px-0">
        <h2 className="text-3xl md:text-4xl font-bold text-white leading-tight text-gradient">
          Ready to explore smarter?
        </h2>

        <p className="w-full md:w-[70%] lg:w-[55%] mx-auto text-sm md:text-lg text-white/85 leading-relaxed">
